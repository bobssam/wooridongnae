...
public class SmallAreaDao {
	...
	public SmallAreaVO view( PageVO pageVO ) {
		return sqlSession.selectOne( "smallArea.view", pageVO );
	}

	public SmallAreaVO viewAreaCode( PageVO pageVO ) {
		return sqlSession.selectOne( "smallArea.viewAreaCode", pageVO );
	}
