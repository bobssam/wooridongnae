...
public final class SMSFactory {
	...
	private String rphone = null; // 받을 폰번호 ex)000-0000-0000 에서 '-' 포함
	private String sphone1 = "1566"; // 전송할 첫번째 폰번호
	private String sphone2 = "6754"; // 전송할 두번째 폰번호
	private String sphone3 = ""; // 전송할 세번째 폰번호
	...
	public SMSFactory(String tempKey, String phone) throws Exception {
		...
		user_id = base64Encode("subasta");	//아이디
		secure = base64Encode("39158c67f877d26c9bd7940a3d41d099");// 인증키
		title = base64Encode(nullcheck(title, ""));
		msg = base64Encode(nullcheck(setMessage(tempKey), ""));
		rphone = base64Encode(nullcheck(phone, ""));
