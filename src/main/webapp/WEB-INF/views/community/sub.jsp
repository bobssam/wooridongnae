...
<style type="text/css">
	...
	table.table td.inner_content img{
		max-width: 100%;
		height: auto;
	}
    	...
    	<div class="content detail" style="display: none;">
			...
			<tbody>
			    <tr>
	   		    ...
	   		    <tr>
			        <td>
			        	글쓴이 : <span data-name="id"></span>
			        </td>
			    </tr>
	   		    <tr>
			        <td data-name="content" data-formatter="brConv" class="inner_content"></td>
			    </tr>
			</tbody>
			</table>
...
$(function(){
	...
	****************************************/
	...
	$('#write_form').on('submit', function(){
		...
		var datas =  $(this).formData();
		var url = isEditMode ? '${root}/api/board/modify' : '${root}/api/board/add';
		datas.where = JSON.stringify({boardNo:datas.boardNo});
