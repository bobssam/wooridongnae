...
@media (max-width: 768px){
	...
	#phoneModal .col-xs-3 , #phoneModal .col-xs-9{
		padding-right: 5px;
		padding-left: 5px;
    ...
    <div class="container content">
        <div class="row">
            <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                <form class="reg-page" method="POST" action="doRegMember" data-toggle="validator" >
                    ...
                    <div class="row">
                        <div class="col-sm-9 col-xs-7">
		                    <input type="text" class="form-control " maxlength="10" name="name" id="name" required title="성함을 적어주시기 바랍니다.">
