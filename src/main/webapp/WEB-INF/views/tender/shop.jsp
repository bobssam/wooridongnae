                ...
                <div class="carousel slide carousel-v1" id="myCarousel">
                    <div class="carousel-inner">
                        <div class="item active">
                            <img alt="" src="${root}/assets/img/main/img11.jpg">
                            <div class="carousel-caption">
                                <p>Facilisis odio, dapibus ac justo acilisis gestinas.</p>
                            </div>
                        </div>
                        <div class="item">
                            <img alt="" src="${root}/assets/img/main/img12.jpg">
                            <div class="carousel-caption">
                                <p>Cras justo odio, dapibus ac facilisis into egestas.</p>
                            </div>
                            </div>
                        <div class="item">
                            <img alt="" src="${root}/assets/img/main/img13.jpg">
                            <div class="carousel-caption">
        ...
        <div class="owl-carousel-v1 owl-work-v1 margin-bottom-40">
            ...
            <div class="owl-recent-works-v1">
                <div class="item">
                    <a href="#">
                        <em class="overflow-hidden">
                            <img class="img-responsive" src="${root}/assets/img/main/img1.jpg" alt="">
                        </em>
                        <span>
                ...
                <div class="item">
                    <a href="#">
                        <em class="overflow-hidden">
                            <img class="img-responsive" src="${root}/assets/img/main/img2.jpg" alt="">
                        </em>
                        <span>
                ...
                <div class="item">
                    <a href="#">
                        <em class="overflow-hidden">
                            <img class="img-responsive" src="${root}/assets/img/main/img3.jpg" alt="">
                        </em>
                        <span>
                ...
                <div class="item">
                    <a href="#">
                        <em class="overflow-hidden">
                            <img class="img-responsive" src="${root}/assets/img/main/img4.jpg" alt="">
                        </em>
                        <span>
                ...
                <div class="item">
                    <a href="#">
                        <em class="overflow-hidden">
                            <img class="img-responsive" src="${root}/assets/img/main/img5.jpg" alt="">
                        </em>
                        <span>
                            <strong>Happy New Year</strong>
                            <i>Anim pariatur cliche reprehenderit</i>
...
<script type="text/javascript" src="${root}/assets/js/plugins/owl-recent-works.js"></script>
